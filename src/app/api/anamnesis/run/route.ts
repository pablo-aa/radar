...
//
// MVP stub: returns mock output until the Anamnesis Managed Agent is wired
// up. Inserts a mock anamnesis_runs row, patches the signed-in user's
// profile with the intake payload, and flips onboard_state.intake_done.
// The persistence shape matches the contract the real Managed Agent will
// emit, so the swap is a one-source change.
...
function parseBody(raw: unknown): IntakeBody {
  if (!raw || typeof raw !== "object") return {};
  const r = raw as Record<string, unknown>;
  return {
    github_handle: optionalString(r.github_handle),
    cv_url: optionalString(r.cv_url),
    site_url: optionalString(r.site_url),
    declared_interests: optionalStringArray(r.declared_interests),
  };
}

// Editorial output shape. Only meta.subject / meta.handle / meta.generated /
// meta.basedOn / headline.lede are per-user; the rest is templated sample
// content used as MVP seed data until the real Managed Agent is wired up.
function buildMockOutput(args: {
  subject: string;
  handle: string;
  generatedAt: string;
  basedOn: string[];
  ...
  return {
    meta: {
      ...
      basedOn: args.basedOn.join(" · "),
      based_on: args.basedOn,
    ...
    timeline: {
      ...
      nodes: [
        ...
        { x: 64, y: 80, label: "T5 transformers, a reading", meta: "2024 · monograph", past: true },
        { x: 74, y: 78, label: "Pablo, today", meta: "2026-04 · reading mode", now: true },
        { x: 86, y: 88, label: "research track", meta: "future · Mercatus / Open Phil", future: true, vector: "A" },
        { x: 88, y: 74, label: "next company", meta: "future · YC path", future: true, vector: "B" },
        { x: 92, y: 62, label: "institution builder", meta: "future · FAPESP / Serrapilheira", future: true, vector: "C" },
      ],
    },
    archetype: {
    ...
    peers: {
      ...
      nodes: [
        { id: 1, x: 28, y: 28, ring: 1, name: "Gwern Branwen", link: "Essayist-engineer. Same monograph habit, same refusal to pick one lane." },
        { id: 2, x: 74, y: 26, ring: 1, name: "Andy Matuschak", link: "Left Apple for independent research. The 'builder who reads' move, done publicly." },
        { id: 3, x: 78, y: 56, ring: 1, name: "Nadia Asparouhova", link: "OSS maintainer turned essayist. Your pt-br community role is analogous." },
        { id: 4, x: 20, y: 66, ring: 2, name: "Filipe Deschamps", link: "BR teacher-builder. The audience shape is yours; the depth is yours to exceed." },
        { id: 5, x: 52, y: 20, ring: 2, name: "Simon Willison", link: "Shipped Django, then became a writer. The exit-to-publish arc is the template." },
        { id: 6, x: 72, y: 80, ring: 2, name: "Shawn Wang (swyx)", link: "Post-bootcamp essayist who built an AI engineer identity. Near the border you patrol." },
        { id: 7, x: 30, y: 82, ring: 2, name: "Matt Rickard", link: "Ex-GitHub, now solo-researching ML systems. Similar cadence, similar gravity." },
      ],
      note:
    ...
    advantages: [
      {
        title: "Exit proof",
        body: "You closed the 'can this person actually ship' question in 2024. Almost no applicant to a research grant has this. Use it in every first sentence where it fits, then move on.",
      },
      {
        title: "Portuguese as a language of craft",
        body: "The pt-br technical sphere is 200M people wide and underserved. You write in it fluently. Most of your global peers cannot; they are locked out of a market you already own.",
      },
      {
        title: "Published monograph, freely readable",
        body: "A thing you made sits on the open web and has been read by people you respect. This is a gravitational object. Grants, fellowships, and hires are the satellites it pulls in.",
      },
      {
        title: "60k direct line",
        body: "An audience built slowly over three years without paid amplification. It is not a vanity metric, it is distribution, applicable to teaching, hiring, and launching.",
      },
      {
        title: "Late-career luxury, early",
        body: "Post-exit liquidity, no dependents, parents' home within a day's drive. You can take a three-year bet that a 32-year-old with a mortgage cannot. This is rarer than it sounds.",
      },
    ],
    vectors: [
      {
        ...
        confidence: 0.72,
        becomes: "A research fellow at a credible institution, writing one major paper per year.",
        year1:
      ...
      },
      {
        ...
        confidence: 0.58,
        becomes: "A founder again, this time in ML tooling for pt-br or broader LatAm developer audiences.",
        year1:
      ...
      },
      {
        ...
        confidence: 0.64,
        becomes: "The person who starts a thing, a lab, a school, a publication, that persists independent of you.",
        year1: "A pt-br ML reading group with 20 engineers, funded by Serrapilheira or a private patron. A newsletter. A named course.",
        year3: "An institution other people work for. A legible place on the Brazilian technical map named after your thesis, not your face.",
        tradeoff:
      ...
      items: [
        {
          ...
          body: "Your strengths are orthogonal to that promotion ladder. The money will feel large for six months and small for the next six years.",
        },
        {
          title: "Do not apply to Chevening or Rhodes-type fellowships",
          body: "Those reward community-leadership framing. Your story reads as technical-and-quiet, which underperforms by 3x in those panels.",
        },
        {
          title: "Do not pivot the Instagram audience toward motivation content",
          body: "The 60k are there for depth. Every diluted post costs you more than it pays. Keep it technical, keep it slow.",
        },
        {
          title: "Do not take VC funding to 'scale' the monograph",
          body: "Writing is not a startup. The offer will come; decline it cleanly. Turn the monograph into a book, or a newsletter, not a platform.",
        },
        {
          title: "Do not move to the United States yet",
          body: "Your unfair advantage is the pt-br sphere. Crossing the border too early turns an asset into a liability. Go for a quarter, not a decade.",
        },
      ],
    },
    yearShape: {
    ...
    readings: [
      {
        ...
        why: "The frame for why you read before you build. Puts the monograph habit in a tradition older than software.",
      },
      {
        kind: "paper",
        title: "On the Opportunities and Risks of Foundation Models",
        author: "Bommasani et al. · Stanford CRFM · 2021",
        why: "A long, imperfect, canonical paper. Your next monograph should have its density without its hedging.",
      },
      {
        kind: "essay",
        title: "The World and the Individual · (selected letters)",
        author: "Jorge Luis Borges",
        why: "You already write in Portuguese; Borges is how you learn to compress in a Romance language.",
      },
      {
        kind: "book",
        title: "Range",
        author: "David Epstein",
        why: "Gives you language for the builder-essayist archetype in public. Useful for grant applications.",
      },
      {
        kind: "paper",
        title: "A Mathematical Framework for Transformer Circuits",
        author: "Elhage et al. · Anthropic · 2021",
        why: "The interpretability province's founding text. Read annually until you can teach it from memory.",
      },
      {
        kind: "book",
        title: "Morte e Vida Severina",
        author: "João Cabral de Melo Neto",
        why: "Pt-br discipline at its hardest. The kind of reading that keeps your Portuguese prose sharp.",
      },
      {
        kind: "talk",
        title: "You and Your Research",
        author: "Richard Hamming · Bell Labs · 1986",
        why: "Read once per quarter. The questions it asks about the shape of a career are the questions Anamnesis is asking you now.",
      },
    ],
  };
}
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  // Auth: require an active session.
  ...
  // Read existing profile so we can coalesce fields (only overwrite where the
  // body supplies a value) and merge onboard_state.
  ...
  if (existing.error) {
    console.error("[api/anamnesis/run] profiles select failed", existing.error);
    return NextResponse.json({ error: "profile_read_failed" }, { status: 500 });
  }

  const effectiveHandle =
    body.github_handle ?? existing.data?.github_handle ?? user.email ?? user.id;

  const nowIso = new Date().toISOString();

  // Coalesce CV / site URLs from the body, falling back to whatever was
  // already on the profile. Only set on the profile update if a value is
  // actually present (don't blow away an existing field).
  const effectiveCvUrl = body.cv_url ?? existing.data?.cv_url ?? null;
  const effectiveSiteUrl = body.site_url ?? existing.data?.site_url ?? null;

  // Best-effort GitHub fetch. Returns null on any error (handle invalid,
  // 404, rate-limit, network). Never throws.
  let ghProfile: GitHubProfile | null = null;
  try {
    ghProfile = await fetchGitHubProfile(effectiveHandle);
  } catch (err) {
    console.warn("[api/anamnesis/run] github fetch threw", err);
  }

  // Build a real `basedOn` list from what we actually have on hand.
  const basedOn: string[] = [];
  if (ghProfile) {
    basedOn.push(`GitHub: ${ghProfile.public_repos} public repos`);
  }
  if (effectiveCvUrl) {
    basedOn.push("CV uploaded");
  }
  if (effectiveSiteUrl) {
    basedOn.push(`Site: ${effectiveSiteUrl}`);
  }
  basedOn.push("Voice note: not yet captured");

  const subject =
    existing.data?.display_name ?? ghProfile?.name ?? effectiveHandle;

  const lede =
    ghProfile?.bio?.trim() ||
    "In computing, this is where your place is. The map below is a first pass.";

  const mockOutput = buildMockOutput({
    subject,
  ...
  if (inserted.error || !inserted.data) {
    console.error("[api/anamnesis/run] run insert failed", inserted.error);
  ...
  // Merge onboard_state.
  const currentOnboard: OnboardState =
    (existing.data?.onboard_state as OnboardState | undefined) ??
    DEFAULT_ONBOARD_STATE;
  const nextOnboard: OnboardState = { ...currentOnboard, intake_done: true };

  // Update profile with provided fields (coalesce) + run id + onboard state.
  const update = await admin
    .from("profiles")
    .update({
      github_handle: body.github_handle ?? existing.data?.github_handle ?? null,
  ...
  if (update.error || !update.data) {
    console.error("[api/anamnesis/run] profile update failed", update.error);
    return NextResponse.json({ error: "profile_update_failed" }, { status: 500 });
  }

  const profile = update.data as Profile;

  return NextResponse.json({ run_id: runId, profile });
}
